...
<div className="chat-message">
  <div className="chat-message-inner">We need to reach out for the latest contact for Purrsload.</div>
</div>
<div className="chat-message">
  <div className="chat-message-inner">Bob, can you do that?</div>
</div>
<div className="chat-message chat-message--self">
  <div className="chat-message-inner">Sure, no problem.</div>
</div>
<div className="chat-message">
  <div className="chat-message-inner">We need to reach out for the latest contact for Purrsload.</div>
</div>
...
<div className="chat-message chat-message--self">
  <div className="chat-message-inner">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Natus, excepturi optio minima fuga cum, consequuntur explicabo, perspiciatis aut impedit nam ex harum quasi asperiores tenetur quibusdam facilis! Recusandae, sequi quaerat.</div>
</div>
</div>
<form>
